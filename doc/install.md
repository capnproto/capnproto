...
<pre><code>curl -O <a href="https://capnproto.org/capnproto-c++-0.5.1.1.tar.gz">https://capnproto.org/capnproto-c++-0.5.1.1.tar.gz</a>
...
1. Download Cap'n Proto Win32 build:
   ...
   <pre><a href="https://capnproto.org/capnproto-c++-win32-0.5.1.1.zip">https://capnproto.org/capnproto-c++-win32-0.5.1.1.zip</a></pre>

2. Find `capnp.exe`, `capnpc-c++.exe`, and `capnpc-capnp.exe` under `capnproto-tools-win32-0.5.1.1` in
...
2. Use CMake to generate Visual Studio project files under `capnproto-c++-0.5.1.1` in the zip file.
