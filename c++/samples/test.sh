...
c++ -std=c++20 -Wall addressbook.c++ addressbook.capnp.c++ \
...
c++ -std=c++20 -Wall calculator-client.c++ calculator.capnp.c++ \
    $(pkg-config --cflags --libs capnp-rpc) -o calculator-client
c++ -std=c++20 -Wall calculator-server.c++ calculator.capnp.c++ \
